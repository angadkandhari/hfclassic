...
public class TestDataCL {
	...
	private static String testEmailValid = "tmstaff1@gmail.com";
	...
	private static String testAccountValidPassword = "tenmiles1";
	...
	public static void setTestRailSuiteId(String testRailSuiteId) {
		TestDataCL.testRailSuiteId = testRailSuiteId;
	}
	...
	public static void setTestRailProjectId(String testRailProjectId) {
		TestDataCL.testRailProjectId = testRailProjectId;
	}
	...
	public static void setTestRailRunId(Object object) {
		TestDataCL.testRailRunId = object;
	}
